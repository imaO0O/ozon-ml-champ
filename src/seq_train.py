...
def main() -> None:
    ...
    #
    # Потолок ограничивает только сверху: лучшая эпоха выбирается по валидации
    # и восстанавливается, поэтому больший потолок навредить не может, он
    # стоит лишь времени (около 17 с на эпоху на RTX 5070).
