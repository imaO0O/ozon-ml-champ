...
#
# Знак положительный во всех трёх, в январе воспроизведён двумя сидами. Вес в
# оптимальном составе крупный (0.41-0.46), у контрольной руки при этом
# отрицательный: дневные ранги плотную сеть не дополняют, а вытесняют. Состав
# целиком 1.66760 против 1.66845 у прежнего лучшего, то есть +0.00085.
#
# Декабрьские 0.00036 сами по себе неотличимы от нуля, и направление держится
# на январе. Асимметрия согласуется с механизмом, но подогнана к двум точкам,
# а не доказана: плотность сетки растёт монотонно (24.5% в августе, 27.0% в
# декабре, 28.4% в январе, 29.2% на тесте), а ранг нормирует на состав
# активных за день, поэтому его польза должна расти по мере ухода окна от
# обучающих срезов. Тест сдвинут сильнее января.
#
