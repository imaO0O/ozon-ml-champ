...
```bash
python -u src/seq_train.py --window 90 --arch gru --seeds 3
python -u src/seq_oof_net.py --name dr90        # OOF по срезам -> models/netoof_dr90_*.npz
python -u src/seq_blend.py --members ...        # состав и веса
```
