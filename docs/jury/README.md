...
Пять содержательных находок, каждая с числом. Это не список приёмов —
это то, что отличает наше решение от добротного бустинга на тех же данных.

### 1. Год истории вместо квартала — и это главная находка
...
### 2. Четыре сети различаются входом, а не архитектурой
...
### 3. Распределительная голова: лучше и точечно, и по существу
...
### 4. Калибровка решается алгеброй, а не подбором
...
### 5. Стекинг решает поклиентно, а не общим весом
