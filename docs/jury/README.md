...
**ИТОГ: 2-е место на private, RMSLE 1.6615862555.** На public было 16-е с 1.6466590 (`pair_s6q.csv`) — четырнадцать позиций выиграно тем,
что финал не выбирался по публичному ответу (разбор в [`A2`](A2_final_selection.md), раздел «ИСХОД»).

**Итог по public: RMSLE 1.6466590** (`pair_s6q.csv`).
