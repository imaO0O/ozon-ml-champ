...
flowchart TB
    ...
    RAW --> FEAT["242 табличных признака<br/>окна 7/14/30/90/180/365, ранги, доли площадки"]
    ...
    FEAT --> GBM["LightGBM, ансамбль 5 конфигураций<br/><b>stk2</b>"]

    TENS --> YEAR["<b>годовая сеть</b><br/>364 дня, недельный шаг<br/>4 сида"]
    TENS --> NOST["сеть без рангов<br/>90 дней, --static нет<br/>4 сида"]
    TENS --> EV["событийная сеть<br/>364 дня, 96 событий<br/>3 сида"]

    GBM --> MIX["<b>mix_multi</b>"]
    YEAR --> MIX
    NOST --> MIX
    EV --> MIX

    TC["половина трека C<br/>cand_w, cand_w2"] --> P1
    MIX --> P1["pair_multi<br/>вес 0.28"]
    P1 --> P2["pair_w2<br/>вес 0.35"]
    P2 --> P3["pair_nost<br/>вес 0.06"]
    P3 --> FIN["<b>pair_q</b><br/>+ кривизна<br/>public 1.6466941"]

    CAL["калибровка после КАЖДОЙ смеси:<br/>уровень 2.32912, растяжение до Var 2.6408"] -.-> P1
    CAL -.-> P2
    CAL -.-> P3
```

Все четыре сети — **одна архитектура GRU** с распределительной головой
на 64 бина. Различаются только тем, **что видят**. Веса в симплексе:
стекинг 0.326, годовая 0.415, без рангов 0.069, событийная 0.190.
