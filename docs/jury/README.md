...
Отвергнутых направлений пятьдесят, принятых пять. Соотношение стоит
...
В `A4` — **пятьдесят направлений**, каждое с числом и с условием, при
...
Пятьдесят направлений, каждое с числом и **с условием, при котором вывод
...
3. [`A4_negative_results.md`](A4_negative_results.md) — пятьдесят
